...
// Namespaces from react-native-job-queue
using ReactNativeJobQueue;
...
namespace Microsoft.ReactNative.Managed
{
    internal static class AutolinkedNativeModules
    {
        ...
        { 
            // IReactPackageProviders from react-native-job-queue
            packageProviders.Add(new ReactNativeJobQueue.ReactPackageProvider());
        }
    }
}
